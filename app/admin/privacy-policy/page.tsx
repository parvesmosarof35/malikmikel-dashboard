...
import { useGetPrivacyQuery, useUpdatePrivacyMutation } from "@/store/api/privacyApi";

export default function PrivacyPolicyPage() {
  const { data: apiData, isLoading: isFetching } = useGetPrivacyQuery(undefined);
  ...
  const handleSubmit = async () => {
    ...
    try {
      await updatePrivacy({ description: content }).unwrap();
